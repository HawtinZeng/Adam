 ...
 */
// @ts-nocheck
import { Point as PointT } from "src/CoreRenderer/basicTypes";
export const potrace = function (cvs) {
  function Point(x, y) {
    this.x = x;
    this.y = y;
  }
  ...
  var imgElement = document.createElement("img"),
    imgCanvas = cvs ?? document.createElement("canvas"),
    bm = null,
    pathlist = [],
    callback,
    info = {
  ...
  function getPath() {
    return pathlist.map((path) => path.pt as PointT[]);
  }
